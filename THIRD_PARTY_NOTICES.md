...
bundle the AI agents or their subscriptions. Some Linux packages rely on the
distribution's separately installed libraries; AppImage packaging may include
additional system-library notices supplied by the packaging tools.
